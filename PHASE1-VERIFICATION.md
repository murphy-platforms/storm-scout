...
```bash
# Check if page loads
curl -s https://your-domain.example.com | grep -o "IMMEDIATE ATTENTION"
```
...
**URL**: https://your-domain.example.com/advisories.html
...
curl -s https://your-domain.example.com/js/aggregation.js | head -n 5
```
...
### Test 6: Sites Page
**URL**: https://your-domain.example.com/sites.html
