...
### View Current Status
- Dashboard: https://teammurphy.rocks
- API Overview: https://teammurphy.rocks/api/status/overview
- Sites Needing Attention: https://teammurphy.rocks/api/operational-status/summary

### Set Operational Status (Example)
```bash
# Close a single site
curl -X POST https://teammurphy.rocks/api/operational-status/sites/82 \
  -H "Content-Type: application/json" \
  -d '{
    "operational_status": "closed",
