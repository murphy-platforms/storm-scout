...
curl 'https://teammurphy.rocks/api/advisories/active?severity=Extreme'

# Test multiple severities (comma-separated)
curl 'https://teammurphy.rocks/api/advisories/active?severity=Extreme,Severe'

# Test combined filters
curl 'https://teammurphy.rocks/api/advisories/active?severity=Extreme&state=CA'
