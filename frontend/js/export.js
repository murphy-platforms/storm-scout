...
<body>
    ...
    <p style="margin-top: 40px; color: #666; font-size: 12px;">
        Report generated by Storm Scout | Weather Advisory Dashboard<br>
        This is an independent project and is not affiliated with, endorsed by, or connected to the United States Postal Service.
    </p>
</body>
</html>
        `;
