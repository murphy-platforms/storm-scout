...
INSERT OR REPLACE INTO site_status (site_id, operational_status, reason, last_updated) VALUES
((SELECT id FROM sites WHERE site_code = '0382'), 'Closed', 'Hurricane Warning - Site evacuated', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0610'), 'Closed', 'Hurricane Warning - Site evacuated', datetime('now')),
((SELECT id FROM sites WHERE site_code = '3251'), 'At Risk', 'Winter Storm Warning - Monitoring conditions', datetime('now')),
((SELECT id FROM sites WHERE site_code = '5194'), 'At Risk', 'Winter Weather Advisory - Reduced operations', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0051'), 'Open', 'Severe Thunderstorm Watch - Operations normal with precautions', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0024'), 'Open', 'No active advisories', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0001'), 'Open', 'No active advisories', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0062'), 'Open', 'No active advisories', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0015'), 'Open', 'No active advisories', datetime('now')),
((SELECT id FROM sites WHERE site_code = '0080'), 'Open', 'No active advisories', datetime('now'));
