...
1. Log into cPanel
2. Open phpMyAdmin
3. Select `mwqtiakilx_stormscout` database
4. Click "SQL" tab
...
```bash
curl -s "https://teammurphy.rocks/api/status/overview" | jq '.operational_status_counts'
```
