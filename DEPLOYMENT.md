...
Deploy Storm Scout to **your-domain.example.com** on Spaceship.com hosting.
...
- Domain: your-domain.example.com configured in DNS
...
### Test Live Site
```bash
curl https://your-domain.example.com/api/sites
...
- Check `.env.production` has `CORS_ORIGIN=https://your-domain.example.com`
