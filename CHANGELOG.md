...
### Fixed
- **Site Data Verification** - Verified all 9 new sites against physical addresses from public sources
...
- **Office (NYC Downtown 2)** - Removed as child office
  - Both sites share same physical address (***REDACTED***)
  - Storm Scout tracks parent site codes only; total offices: *** → 1259
...
- Miami alternate address (400 Placeholder Dr) used when ***REDACTED*** not in Census database
...
### Data Sources
- Addresses sourced from public location data
