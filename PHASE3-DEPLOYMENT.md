...
ssh -p 21098 mmurphy@66.29.148.111
...
# Rsync backend files
rsync -avz -e "ssh -p 21098" backend/ stormscout:~/backend/ \
...
#### Test Map View
1. Navigate to https://teammurphy.rocks/map.html
...
2. Navigate to https://teammurphy.rocks/api/trends
...
2. Navigate to https://teammurphy.rocks
...
rsync -avz -e "ssh -p 21098" backend/ stormscout:~/backend/ --exclude node_modules
ssh -p 21098 stormscout "pm2 restart storm-scout"
```
