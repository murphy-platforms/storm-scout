...
ssh -p 21098 mwqtiakilx@teammurphy.rocks "touch ~/storm-scout/tmp/restart.txt"
```
...
- **SSH**: `ssh -p 21098 mwqtiakilx@teammurphy.rocks`
...
- [ ] Health check passes: `https://teammurphy.rocks/health`
- [ ] Frontend loads: `https://teammurphy.rocks`
- [ ] API responds: `https://teammurphy.rocks/api/sites`
...
### Backend Won't Start
1. Check MySQL connection: `mysql -u mwqtiakilx_stormsc -p mwqtiakilx_stormscout`
...
### Deployment Fails
1. Test SSH connection: `ssh -p 21098 mwqtiakilx@teammurphy.rocks`
...
### Branch Strategy
- **main**: Production-ready code, deployed to https://teammurphy.rocks
...
curl https://teammurphy.rocks/health  # Check production
