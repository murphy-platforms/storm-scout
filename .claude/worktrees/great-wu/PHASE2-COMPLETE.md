...
**Example**: https://your-domain.example.com/site-detail.html?site=2703
...
**URL**: https://your-domain.example.com/site-detail.html?site=2703
...
curl -s 'https://your-domain.example.com/site-detail.html?site=2703' | grep -i "recommendation"
```
...
**From Advisories**:
1. Visit https://your-domain.example.com/advisories.html
2. Click site code in any card header
3. ✅ Navigates to site detail

**From Sites**:
1. Visit https://your-domain.example.com/sites.html
...
**URL**: https://your-domain.example.com/site-detail.html?site=9999
...
**Production URL**: https://your-domain.example.com/site-detail.html?site=2703  
