...
```bash
✅ Classic UI: https://your-domain.example.com/index.html
   - Status: 200 OK
   - Load Time: 0.468s
   - Title: "Storm Scout - Overview"

✅ Beta UI: https://your-domain.example.com/beta/index.html
   - Status: 200 OK
...
- [x] Classic UI loads (https://your-domain.example.com)
- [x] Beta UI loads (https://your-domain.example.com/beta/)
